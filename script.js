...
const BASE_URL = "https://cdn.jsdelivr.net/npm/@fawazahmed0/currency-api@2025.3.10/v1/currencies"
...
btn.addEventListener("click", async (evt) => {
    ...
    let matchedValue = 0;
    if (data[fromCurrVal] && data[fromCurrVal].hasOwnProperty(toCurrVal)) {
        matchedValue = data[fromCurrVal][toCurrVal];
    }
    let finalAmount = matchedValue * amountValue;
